...
htmlhelp_basename = 'neutron-powervmdoc'
...
latex_documents = [
  ('index', 'neutron-powervm.tex', u'neutron-powervm Documentation',
...
man_pages = [
    ('index', 'neutron-powervm', u'neutron-powervm Documentation',
...
texinfo_documents = [
  ('index', 'neutron-powervm', u'neutron-powervm Documentation',
   u'Adam Reznechek, Drew Thorstensen', 'neutron-powervm', 'One line description of project.',
   'Miscellaneous'),
]
